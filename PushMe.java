   ...
   @Override
      ...
      public void start(Stage stage) {
         ...
         Button upperCaseButton = new Button();
            upperCaseButton.setText("push this to covert to upper case");
         ...
         Button lowerCaseButton = new Button();
            lowerCaseButton.setText("push this to convert to lower case");
         ...
         stage.setScene(scene);
            stage.setTitle("Andrey Lexter Gumata");
               stage.show();        
      }
